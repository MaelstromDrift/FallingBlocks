...
package com.mark.games.fallingblocks.framework.gl.text;
...
public class TexampleRenderer implements GLSurfaceView.Renderer  {
   ...
   public static Context context;                           // Context (from Activity)
   ...
   public TexampleRenderer(Context context)  {
      super();
      TexampleRenderer.context = context;                         // Save Specified Context
   }
